    ...
    window.addEventListener("load", () => {
      ...
      const draw = () => {
        ...
        let t = date.getMinutes() * 60 +
                date.getSeconds() +
                date.getMilliseconds() / 1000;
        prim.world = rotateX(t * 3, vec3(0, 1, 0)).mul(translate(vec3(0, 0, -8)));
        prim.draw(rnd);
        rnd1.render();
        prim1.world = rotateX(t * 2, vec3(0, 1, 0)).mul(translate(vec3(0, 0, -8)));
        prim1.draw(rnd1);
